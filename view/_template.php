            ...
            <li>
							<div >
									...
									<div>
										...
										<a href="#" id="show_unlock_private_key" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#privateUnlockModal" title="Unlock your private key, this is only nessesary if you choose a different password than account password.">Unlock private key</a>
